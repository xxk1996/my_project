...
/* the debug log will force enable when JS_DEBUG macro is defined */
#if defined(JS_DEBUG) && !defined(DBG_ENABLE)
#define DBG_ENABLE
#endif

/* it will force output color log when JS_DEBUG_COLOR macro is defined */
#if defined(JS_DEBUG_COLOR) && !defined(DBG_COLOR)
#define DBG_COLOR
#endif
